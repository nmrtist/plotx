    ...
    vec![
        (
            ...
            vec![
                ...
                Command(CommandId::ImportImage),
                Command(CommandId::ImportImageFirstFrame),
                Command(CommandId::ImportImageWithoutMetadata),
                Command(CommandId::ImportTiffPages),
                Command(CommandId::PasteImage),
                Command(CommandId::CancelImageImport),
        ...
        (
            ...
            vec![
                ...
                Submenu(
                    "Panel",
                    vec![
                        Command(CommandId::ComposePanel),
                        Command(CommandId::DissolvePanel),
                        Command(CommandId::DeletePanel),
                        Command(CommandId::DuplicatePanel),
                        Command(CommandId::MergePanels),
                        Command(CommandId::SplitPanel),
                        Separator,
                        Command(CommandId::SetPanelLayout(
                            plotx_core::state::PanelLayout::Free,
                        )),
                        Command(CommandId::SetPanelLayout(
                            plotx_core::state::PanelLayout::VerticalStack,
                        )),
                        Command(CommandId::SetPanelLayout(
                            plotx_core::state::PanelLayout::HorizontalStack,
                        )),
                        Command(CommandId::SetPanelLayout(
                            plotx_core::state::PanelLayout::Grid { rows: 2, cols: 2 },
                        )),
                        Separator,
                        Command(CommandId::ReorderPanelLabels),
                    ],
                ),
                Command(CommandId::ReplaceImage),
                Separator,
