    ...
    let run = MassSpecRun {
        ...
        streams: vec![AcquisitionStream {
            ...
            spectra: vec![MassSpectrum {
                ...
                acquisition: plotx_io::SpectrumAcquisition::default(),
                mz: vec![20.0, 40.0],
                intensity: vec![2.0, 5.0],
                tic: 7.0,
                tic_provenance: plotx_io::SpectrumSummaryProvenance::Derived,
                base_peak_mz: Some(40.0),
                base_peak_intensity: Some(5.0),
                base_peak_provenance: plotx_io::SpectrumSummaryProvenance::Derived,
                precursor: None,
            }],
        }],
