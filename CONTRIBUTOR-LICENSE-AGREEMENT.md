# PlotX Contributor License Agreement

Version 1.0, 21 July 2026

Thank you for your interest in contributing to PlotX. In this Agreement, "We"
or "Us" means Jiekang Tian, owner of the official PlotX repository at
<https://github.com/nmrtist/plotx>.

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please accept it by
electronic submission, following the instructions in Section 7. This is a
...
GPL-3.0-or-later (including any right to adopt any future version of a license
if permitted).
...
than eighteen years old, please have Your parents or guardian accept the
Agreement.
...
6.3 The failure of either party to require performance by the other party of
...
6.5 This Agreement is published with a version number. A later version applies
only to Contributions for which You accept that version; changing the published
text does not change an Agreement already accepted.
...
Agreement, version 1.0, using Outbound License Option Five. The Harmony
agreements are published by Project Harmony at
<https://www.harmonyagreements.org/> under a
